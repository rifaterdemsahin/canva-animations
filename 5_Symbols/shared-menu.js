    ...
    if (menuPlaceholder) {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html">🏠 Animated Tech Concepts</a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="conceptsDropdown">
                                <li><a class="dropdown-item" href="concepts/1-docker-containerization.html">1. Docker</a></li>
                                <li><a class="dropdown-item" href="concepts/2-ci-cd-pipeline.html">2. CI/CD</a></li>
                                <li><a class="dropdown-item" href="concepts/3-git-branching.html">3. Git Branching</a></li>
                                <li><a class="dropdown-item" href="concepts/4-api-cycle.html">4. API Cycle</a></li>
                                <li><a class="dropdown-item" href="concepts/5-kubernetes-pods.html">5. K8s Pods</a></li>
                                <li><a class="dropdown-item" href="concepts/6-css-box-model.html">6. CSS Box Model</a></li>
                                <li><a class="dropdown-item" href="concepts/7-env-variables.html">7. Env Variables</a></li>
                                <li><a class="dropdown-item" href="concepts/8-git-merge-rebase.html">8. Git Merge/Rebase</a></li>
                                <li><a class="dropdown-item" href="concepts/9-prometheus-scraping.html">9. Prometheus</a></li>
                                <li><a class="dropdown-item" href="concepts/10-js-event-loop.html">10. Event Loop</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="workflowDropdown">
                                <li><a class="dropdown-item" href="render.html?page=../gemini.md">Overall Process</a></li>
                                <li><a class="dropdown-item" href="render.html?page=../4_formulas/01_end_to_end_workflow.md">1. End-to-End Workflow</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://github.com/rifaterdemsahin/canva-animations" target="_blank" title="GitHub Repository">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16" style="vertical-align: -0.125em;">
